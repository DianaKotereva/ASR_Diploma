...
if __name__ == '__main__':
    ...
    # setup logger
    # Загрузка модели и подготовка логгирования
    ...
    # Для нашей модели требуется уточнить, какая буквы отвечает за пустышку в нашем варианте!
